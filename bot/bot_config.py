...
class BotConfig(webdriver.Chrome):
    ...
    def __init__(self) -> None:
        ...
        super().__init__(service=service,options=options,desired_capabilities=capabilities)
    ...
    def __setCapabilities(self):
        ...
        response = requests_get("http://ipinfo.io/json",proxies={'http':proxy.http_proxy})
