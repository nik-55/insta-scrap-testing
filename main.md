...
So join our livestream and get ready to take notes on 3rd December 4:00 PM on our YouTube channel @MDGIITR: (link in QR and bio)

You can fill this form with any doubts you have; we'll answer them all in our talk: (link in bio)
...
Codephile is a social networking application for competitive coders. With Codephile, you can track your and your friends' progress, be informed about programming contests, and much more!
...
PS: MDG Space is a team of enthusiastic students who aim to explore, ideate and develop products over a vast range of software technologies in the IIT Roorkee campus and beyond. We have a bunch of software wizards and design sorcerers who enjoy crafting spells with design and code to engineer robust and innovative solutions. We actively foster the open source culture and other tech-based know-how within the campus and all over the world.
...
Appetizer is an app developed by MDG in collaboration with Hostel Council, which brings to you the best of mess experience to your phone with real time notifications, Mess Menu display and a special feature which lets you skip any meal you are not excited about and helps you get a rebate. It also has a self-contained system for feedback and suggestions.
...
Basic JavaScript will be a prerequisite, everything else will be covered during the workshop.

You are requested to bring your laptops with nvm [github.com/nvm-sh/nvm (For Linux and MacOS), github.com/coreybutler/nvm-windows (For Windows)] and MongoDB [mongodb.com/docs/manual/administration/install-community/] installed to help you follow along and get your doubts cleared on the spot.

Resources will be shared after the workshop. As a bonus, refreshments will also be provided at the end of the session :)
...
For developers: We have two challenges for first yearites:

1) Assignment 
Details about the assignment are here: bit.ly/3KJSVya. The assignment deadline is 20th March, 11:59 PM, so buckle up!

2) Recruitment Test
The recruitment test will be on 20th March from 12 noon to 2 PM. Register for the test here: bit.ly/3q2cWbz. Only registered students will be sent the link for the test, so make sure to do it quickly. Syllabus of the test will consist of aptitude and logical reasoning, programming (not language specific) and other sections to assess your thinking skills.

Although it’s not compulsory, we highly recommend you to attempt both of these to increase your chances of selection.

For designers: Both 1st and 2nd year students are eligible for designer positions. We have released problem statements for you here: bit.ly/3w3NLJr, which are to be submitted by 20th March, 11:59 PM.

Make sure to be on schedule as no submissions will be accepted post deadline. All the other instructions and resource links are present in the assignments or test itself.
...
Teams/Solo Developers: https://forms.gle/dBKL5YrKxw5Bm6bz7

Have doubts regarding how to proceed, or feeling stuck somewhere? Seeing a large number of queries regarding the SoC programme, we are keeping an AMA (Ask me anything) session tomorrow, 2nd February at 6 PM. See you there!
...
Youtube links:
Workshop 1 - https://youtu.be/BFd6syGPvoM
Workshop 2 - https://youtu.be/S9b4jxPUCfQ

Slides link:
Workshop 1 -https://docs.google.com/presentation/d/17LG9QXAkaXa0md9NBLrDdEZxpWduvxDb5B7ArZKdIrs/edit?usp=sharing
Workshop 2- https://docs.google.com/presentation/d/1nwe47-uvVystchCldkr2mfpdy-UIznFphVqpubcTzgo/edit?usp=sharing

Tasks:
 Read about async/await.
 Check out the code of the app at github.com/mdg-iitr-learning/Open-Lectures-2022
 Recreate the app in your own way using MVVM.
 Push the code to GitHub and send us a link on our public Slack workspace.

Resources:
 Example repo for MVVM/Provider: github.com/mdgspace/appetizer-flutter
 Firebase for Flutter apps: firebase.flutter.dev/docs/overview

Contact us:
 MDG Space Chat
 MDG Slack Open Space
...
We'll be streaming our workshop live on our YouTube channel : https://www.youtube.com/c/MDGIITR

If you missed our previous workshop, you can find it here: https://www.youtube.com/watch?v=BFd6syGPvoM
All the resources for it can be found in the video description.

We also recommend you complete the tasks we mentioned in our previous workshop:
1. Installation to your first app: flutter.dev/docs/get-started/install
2. Building UI:  docs.flutter.dev/development/ui/layout/tutorial
3. Adding interactivity: docs.flutter.dev/development/ui/interactive
...
Tasks:
Installation to your first app: flutter.dev/docs/get-started/install
Building UI:  docs.flutter.dev/development/ui/layout/tutorial
Adding interactivity: docs.flutter.dev/development/ui/interactive
Resources:
Official sites: https://flutter.dev/, https://pub.dev/
Catalog of widgets: flutter.dev/docs/development/ui
We recommend following these resources and will be happy to answer your doubts that come up. You can contact us here:
mdg.iitr.ac.in/chat
Open Source community link
Keep Learning 😄
...
We'll be streaming our workshop on our Youtube channel : https://www.youtube.com/c/MDGIITR

*Add the event to your calendar using https://bit.ly/3qCCL2o *

Install Android Studio or VS Code if you want to follow along! You can find the steps to install it, here: 
Android Studio: https://developer.android.com/studio/install
VS Code: https://code.visualstudio.com/docs/setup/setup-overview
...
If your proposal is selected, you’ll be mentored by our team under whom you will develop your proposals into reality. Open to all freshers and sophomores. The deadline to submit your proposal is 10th of February, 2023. Selected freshers get a direct interview to SDSLabs!
...
Register now for the event at https://globalgamejam.org/2023/jam-sites/sdslabs
We will be launching the jam on 3rd February at 5 PM and will be live for 48 hours. The mode of communication for this event would be discord and in-person at SDSLabs, so make sure to join the SDSLabs Discord server. (Link in bio)

The event will be preceded by the prep week, where the sponsors and community of GGJ would be providing content to get you ready for the jam.

The theme of GGJ 2023 will be revealed globally prior to the start of the jam on twitch.tv/globalgamejam on 28 Jan 2023

Do check out https://globalgamejam.org/news/meet-sponsors-global-game-jam-2023 where various sponsors like GameMaker, Houdini and Avaturn are providing free licenses for their products and other bonuses!

PS: We know that the freshers would be having their ETEs during these dates, and so you can start working on your games earlier than the jam timing (In the GGJ Prep week - read here: https://globalgamejam.org/important-dates). You will just have to do the final submission between 3-5 February. Keep in mind that this is just for the freshers, we expect other participants to participate in the jam for the stipulated 48 hr timeline.

Register for the event: https://globalgamejam.org/2023/jam-sites/sdslabs

Join our Discord server: https://discord.gg/gThNeXG5j4
...
Harkirat Singh (2018 Grad)
Nipun Vashishtha (2020 Grad)
...
Venue: MAC Audi
Timings: 13th January, 6:30pm

Compulsory for all participants to attend. We’ll explain all rules, tracks and submission details. 
...
Scan the QR code or tap the link to join the meet. https://iitroorkee.webex.com/iitroorkee/j.php?MTID=mf24e27fe613f0dcca13464e51fa2da6e
...
Time: January 7th, 9:00pm

Scan the QR or tap the link below to join up: https://iitroorkee.webex.com/iitroorkee/j.php?MTID=mffb5430c0a15c23cebd24ec7b815ac1c
...
Mode: Online
Scan the QR code or tap on the link to join.

https://iitroorkee.webex.com/iitroorkee/j.php?MTID=mf27533a8a53e84e760acd08ee98d09bd
...
To get Ubuntu installed, you are requested to bring your own:
* Laptop
* Charger
* Optional: An Ubuntu 20.04 bootable pen drive (or at least a working pen drive if you forget to make it bootable, although it’s recommended to save time).

The time slot is mentioned in the poster. Please come at the beginning of the slot.

Here is a link to the instructions on creating a bootable pen drive for Ubuntu installation: https://ubuntu.com/tutorials/create-a-usb-stick-on-windows

Refer to this link to check if your disk uses MBR or GPT partition style. Knowing this will ease the process for you: https://pureinfotech.com/check-gpt-mbr-partition-windows-10/

Also, knowing the boot mode the system uses is useful. You can follow this link to read about it: https://itsfoss.com/check-uefi-or-bios/

If you cannot follow any of these, feel free to drop a message at https://chat.sdslabs.co or our Discord server: https://discord.gg/ffh5s8xhRH or just come and attend the party. We will help you get set up.
...
Balsamiq helps people create software and websites that are easier to use, by creating a low fidelity wireframing tool. Check them out at: https://balsamiq.com/

echo3D is a 3D-focused API and cloud infrastructure to store, update, secure, and stream 3D content for real-time applications. Check them out at https://www.echo3d.com/

Fueler is an online platform to help you showcase your work on the internet. It's like Github but for Generalist individuals. Check them out at https://fueler.io/
